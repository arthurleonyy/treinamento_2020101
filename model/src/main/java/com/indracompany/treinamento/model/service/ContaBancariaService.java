...
public class ContaBancariaService extends GenericCrudService<ContaBancaria, Long, ContaBancariaRepository>{
	...
	public void depositar (String agencia, String numeroConta, double valor, String descricao) {
		...
		extratoBancarioService.registarOperacaoExtrato(conta, descricao == null ? "DEPOSITO" : descricao, valor, 'C', LocalDate.now());
	}
	...
	public void sacar (String agencia, String numeroConta, double valor, String descricao) {
		...
		extratoBancarioService.registarOperacaoExtrato(conta, descricao == null ? "SAQUE" : descricao, valor, 'D', LocalDate.now());
	}
...
//	public List<ContaBancaria> extratoConta(String agencia, String numeroConta) {
//		ContaBancaria conta = this.consultaConta(agencia, numeroConta);	
//		return conta.getAgencia().get
//	}
